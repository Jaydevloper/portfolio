...
let projects = [
  {
    image: "textures/movie.jpg",
    url: "https://uzkinolar.netlify.app/",
  },
  {
    image: "textures/easybank.jpg",
    url: "https://phoda.netlify.app/",
  },
  {
    image: "textures/turkme.jpg",
    url: "https://turkmen-ex-import.netlify.app/",
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("Jakhangir Radjabov", {
      font: font,
      size: 0.06,
      height: 0.01,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      "Frontend Devloper / React / Typescript",
      {
        font: font,
        size: 0.018,
        height: 0,
